...
3. Al registrarse exitosamente, el sistema devuelve un token JWT.
...
> Nota: la HU original mencionaba filtro por talla, color y categoría, pero el MVP recorta esto a **solo categoría** para la v1.
...
- Cambiar el estado del envío: Pendiente / Enviado / Entregado
